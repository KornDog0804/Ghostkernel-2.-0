    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val screenStack = remember {
                if (initialScreenId == SettingsDestinations.MUSIC_DNA)
                    mutableStateListOf(SettingsDestinations.MAIN, SettingsDestinations.MORE, initialScreenId)
                else
                    mutableStateListOf(initialScreenId)
            }

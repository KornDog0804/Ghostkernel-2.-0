...
fun Context.queryMediaStoreSongs(): List<Song> {
    ...
    // Exclude short clips (ringtone/notification generator output) alongside the IS_MUSIC check
    val minDurationMs = 30_000
    ...
    contentResolver.query(
        ...
        while (cursor.moveToNext()) {
            ...
            // MediaStore writes the literal string "<unknown>" when a file has no artist tag
            val artist = if (rawArtist.isNullOrBlank() || rawArtist == "<unknown>") null else rawArtist

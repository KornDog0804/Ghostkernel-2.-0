    ...
    SettingsScreenLayout(
        ...
        content = {
            when (screenId) {
                ...
                SettingsDestinations.MORE -> MoreSettingsContent(onOptionClick = onOptionClick)
                ...
                SettingsDestinations.MUSIC_DNA -> com.github.soundpod.musicprofile.MusicProfileScreen(onBack = onBackClick)
            }
        }
    )
}

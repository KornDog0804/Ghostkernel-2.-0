...
fun QuickPicks(
    ...
    Column(
        ...
        if (related != null) {
            Text(
                text = when (quickPicksSource) {
                    QuickPicksSource.Trending -> "Ghost Picks"
                    QuickPicksSource.LastPlayed -> "Recently Haunted"
                    QuickPicksSource.Recommended -> "Ghost Recommends"
                    QuickPicksSource.Custom -> "Custom Crate Dig"
                },
